...
export default async function AutomatePage({ params }: ServicePageProps) {
  ...
  return (
    <div className="min-h-screen">
      <section className="section-padding bg-primary-50" aria-labelledby="automate-heading">
        <div className="container-custom">
          <div className="max-w-2xl mx-auto text-center mb-16">
            <span className="text-xs font-medium text-accent-600 uppercase tracking-wider">04 — AUTOMATE</span>
            <h1 id="automate-heading" className="mt-2 heading-lg text-primary-950">
              {svc.headline}
            </h1>
      ...
      <section className="section-padding bg-primary-950" aria-labelledby="cta-heading">
        <div className="container-custom text-center">
          <h2 id="cta-heading" className="heading-lg text-white">
            Ready to build systems that compound while you sleep?
          </h2>
          <p className="mt-4 body-lg text-primary-300 max-w-2xl mx-auto">
            AI qualification agents, automated follow-up, dynamic personalization, revenue forecasting, retention workflows. Integration with your existing stack.
          </p>
          <div className="mt-10">
